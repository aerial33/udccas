...
// Import de la bibliothèque D3.js pour la manipulation de données et la visualisation
...
export const GirondeMap = ({
  ...
  useEffect(() => {
    ...
    svg
      .attr('width', width)
      .attr('height', height)
      .attr('viewBox', '0 0 497 630')
      .attr('preserveAspectRatio', 'xMidYMid meet')

    // Ajouter les définitions pour les filtres
  ...
  return (
    <div className="relative w-full">
      ...
      <svg
        ref={svgRef}
        className="h-[400px] w-full max-w-full md:h-[700px]"
        style={{ display: 'block' }}
      ></svg>
